...
def submit_evento(request):
    if request.POST:
        ...
        if id_evento:
            ...
            if evento.usuario == usuario:   #validação do evento de acordo com o usuario selecionado.
                    evento.titulo = titulo
                    evento.descricao = descricao
                    evento.data_evento = data_evento
                    evento.save()

           # Evento.objects.filter(id=id_evento).update(titulo=titulo, #outra forma de validação
